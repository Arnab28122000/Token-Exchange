...
contract Exchange{
    ...
    mapping(uint256 => _Order) public orders;// storing the orders
    ...
    function _trade(uint256 _orderId, address _user, address _tokenGet, uint256 _amountGet, address _tokenGive, uint256 _amountGive) internal {
        ...
        tokens[_tokenGet][feeAccount] = tokens[_tokenGet][feeAccount].add(_feeAmount);//collect fees
